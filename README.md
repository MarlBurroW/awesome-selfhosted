...
- [KinBot](https://github.com/MarlBurroW/kinbot) - Self-hosted AI agent platform with persistent memory, multi-agent collaboration, cron scheduling, and 6 messaging channels (Telegram, Discord, Slack, WhatsApp, Signal, Matrix). Supports 23+ LLM providers including Ollama. ([Demo](https://marlburrow.github.io/kinbot/), [Source Code](https://github.com/MarlBurroW/kinbot)) `MIT` `Nodejs/Docker`
